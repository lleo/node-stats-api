 ...
 *
 */
var Timer = Stats.Timer = function Timer() {
  Stat.call(this)
  this.value = undefined
  this.units = "ms"
}
 ...
 *
 */
var MovingAverage = Stats.MovingAverage =
 ...
 *
 */
var RunningAverage = Stats.RunningAverage =
...
var Bucketer = Stats.Bucketer = function Bucketer(){}

var Linear = Stats.Linear = function Linear(opt) {
  Bucketer.call(this)
...
function SemiLogMS__order(bucket) {
  ...
  //log("SemiLogMS__order: bkt=%s; order=%d;", bucket, order+f)
...
var Bytes = Stats.Bytes = function Bytes() {
  Bucketer.call(this)
}
...
var SemiBytes = Stats.SemiBytes = function SemiBytes() {
  Bytes.call(this)
}
...
var LogBytes = Stats.LogBytes = function LogBytes() {
  Bytes.call(this)
}
